...
class SBBreakpoint(_object):
    ...
    def GetDescription(self, description):
        ...
        return _lldb.SBBreakpoint_GetDescription(self, description)
...
class SBTarget(_object):
    ...
    def BreakpointCreateByNames(self, *args):
        """
        BreakpointCreateByNames(SBTarget self, str const *[] symbol_name, uint32_t num_names, uint32_t name_type_mask, SBFileSpecList module_list, SBFileSpecList comp_unit_list) -> SBBreakpoint
        BreakpointCreateByNames(SBTarget self, str const *[] symbol_name, uint32_t num_names, uint32_t name_type_mask, lldb::LanguageType symbol_language, SBFileSpecList module_list, SBFileSpecList comp_unit_list) -> SBBreakpoint
        """
...
class SBThread(_object):
    ...
    def StepUsingScriptedThreadPlan(self, script_class_name):
        """StepUsingScriptedThreadPlan(SBThread self, str const * script_class_name) -> SBError"""
        return _lldb.SBThread_StepUsingScriptedThreadPlan(self, script_class_name)
    ...
    def GetDescription(self, description):
        ...
        return _lldb.SBThread_GetDescription(self, description)
