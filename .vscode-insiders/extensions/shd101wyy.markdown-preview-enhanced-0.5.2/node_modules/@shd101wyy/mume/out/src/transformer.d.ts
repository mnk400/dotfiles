 ...
 * @param param3
 */
export declare function transformMarkdown(inputString: string, { fileDirectoryPath, projectDirectoryPath, filesCache, useRelativeFilePath, forPreview, forMarkdownExport, protocolsWhiteListRegExp, notSourceFile, imageDirectoryPath, usePandocParser, headingIdGenerator, }: TransformMarkdownOptions): Promise<TransformMarkdownOutput>;
