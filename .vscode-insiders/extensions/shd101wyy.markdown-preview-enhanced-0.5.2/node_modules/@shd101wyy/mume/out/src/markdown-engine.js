...
class MarkdownEngine {
    ...
    */
    ...
    generateScriptsForPreview(isForPresentation = false, yamlConfig = {}, isForVSCode = false) {
        ...
        // zenuml
        scripts += `<script type="text/javascript" src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/sequence-diagram/vue.js"), isForVSCode)}" charset="UTF-8"></script>`;
        scripts += `<script type="text/javascript" src="${utility.addFileProtocol(path.resolve(utility.extensionDirectoryPath, "./dependencies/sequence-diagram/sequence-diagram.min.js"), isForVSCode)}" charset="UTF-8"></script>`;
        // wavedrome
